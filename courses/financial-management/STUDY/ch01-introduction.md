...
> **핵심 한 문장**: 기업재무는 결국 *세 질문* — 무엇에 투자하나(capital budgeting)·어떻게 조달하나(capital structure)·단기 현금을 어떻게 굴리나(working capital) — 으로 환원되고, 그 답의 잣대는 언제나 **주주 부(가치) 극대화** 다.

이 책 전체의 지도가 1장에 담겨 있다:

1. **세 질문 = 대차대조표의 세 자리**(figure 1.1): *왼쪽(자산)* = 어디에 투자할까, *오른쪽(부채+자본)* = 어떻게 조달할까, 둘 사이의 *순운전자본* = 단기를 어떻게 관리할까. Part II·IV·VII 이 각각을 맡는다.
2. **누가 결정하나** — 재무관리자(figure 1.2 의 조직도상 CFO 산하). 그가 다루는 건 *회계이익이 아니라 cash flow* — 그리고 cash flow 는 *식별·시점·위험* 의 세 요소로 가치가 매겨진다.
3. **무엇을 위해** — *주주 부 극대화*. 그런데 경영자는 주주가 아니므로 이해가 갈린다(*agency problem*) → 모니터링·인센티브·규제(SOX)로 그 간극을 좁힌다.
4. **어떤 그릇에서** — sole proprietorship·partnership·*corporation*. 유한책임·영속성·자본조달 이점 때문에 대규모 사업은 corporation 이 지배적.

한 문장으로: **재무는 "가치를 높이는 세 결정"이고, 가치는 위험을 감안한 미래 cash flow 의 현재가치다.**
